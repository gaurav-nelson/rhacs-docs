...
- xref:64.0@rhacs:installing:install-ocp-operator.adoc[Installing by using an Operator]

- *xref:64.0@rhacs:installing:install-ocp-operator.adoc#installing-using-an-operator[Installing by using an Operator]*: Learn how to install {product-title} on {ocp} by using the {product-title} Operator.
- *xref:64.0@rhacs:installing:installing_helm/install-helm-quick.adoc#install-helm-quick[Installing quickly using Helm charts]*: Learn how to install {product-title} by using Helm charts.
